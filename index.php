...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
                    <li><a class="current" href="index.php">User Info</a></li>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            <th scope="col" class="rounded">Údaj</th>
            <th scope="col" class="rounded">Hodnota</th>
        </tr>
    </thead>
    <tbody>
    	<tr>
            <td>Priviedol ťa</td>
            <td><? $username = $_SESSION["loginmeno"]; $a = mysql_query("SELECT referal FROM authme where username = '$username'"); echo mysql_result($a,"0"); ?></td>
        </tr>
        
    	<tr>
            <td>Poceť privedených hráčov</td>
            <td><? $username = $_SESSION["loginmeno"]; $a = mysql_query("SELECT nalakany FROM authme where username = '$username'"); echo mysql_result($a,"0"); ?></td>
        </tr> 
        
    	<tr>
            <td>Počet kreditov</td>
            <td><? $username = $_SESSION["loginmeno"]; $a = mysql_query("SELECT kredity FROM authme where username = '$username'"); echo mysql_result($a,"0"); ?></td>
        </tr>   
