...
if($email == "" || $predmet == "" || $sprava == ""){
	echo '
	<center><img src="images/error.png"><font color="red">Nezadal si email, predmet alebo správu.</font></center>
	';
}else{
mail("cooperpack@empis.eu", $predmet." - Od ".$email,$sprava); 
echo '
<center><img src="images/valid.png"><font color="green">Správa úspešne odoslaná.</font></center>
';
}
}
?>
<div class="form">
         <form action="?" method="post" class="niceform">
			<fieldset>
					...
					<dl>
                        <dt><label for="email">Predmet:</label></dt>
                        <dd><input type="text" name="subject" id="" size="54" /></dd>
                    </dl>
					<dl>
                        <dt><label for="comments">Správa:</label></dt>
                        <dd><textarea name="message" id="comments" rows="5" cols="36"></textarea></dd>
                    </dl>
					<dl class="submit">
                    <input type="submit" name="send" id="submit" value="Odoslať" />
                     </dl>
			</fieldset>
		 </form>
		 </div>
