...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
						...
						<li><a class="current" href="shopvip.php" title="">Vip</a></li>
                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                        </ul>
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
    ...
    <h2>Kúpiť vip</h2> 
<?
if (isset($_POST['kupitvip'])) {
$pdni = $_POST["pocetdni"];
if($pdni == ""){
echo '<center><img src="images/error.png"><font color="red">Nezadal si počet dní.</font></center>';
}else{
//connect to db
include_once 'config.php';
$ucet = $_SESSION["loginmeno"];
$query = mysql_query("SELECT * FROM `authme` WHERE `username` = '$ucet'");
$row = mysql_fetch_array($query, MYSQL_ASSOC);
$time = $pdni * 86400;
$cena = $pdni * $vip;
if($row["kredity"] < $cena){
echo '<center><img src="images/error.png"><font color="red">Nemáš dostatok kreditov.</font></center>';
}else{
    ...
    if($ws->connect()){
        $ws->doCommandAsConsole('pex user '.$ucet.' group add vip "" '.$time);
        $ws->disconnect();
		$kredityset = $row["kredity"]-$cena;
		mysql_query("UPDATE `authme` SET `kredity`='$kredityset' WHERE `username`='$ucet'");
		echo "<center><img src='images/valid.png'><font color='green'>Vip kúpené na $pdni dni.</font></center>";
    }else{
...
<div class="form">
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
					<dl>
						<dt></dt>
                        <dd><center><label for="email">Vip na jeden deň stojí <? include_once "config.php"; echo $vip;?> kreditov.</label></center></dd>
                    </dl>
                    <dl>
                        <dt><label for="email">Počet dní:</label></dt>
                        <dd><input type="text" name="pocetdni" id="" size="54" /></dd>
                    </dl>
					<dl class="submit">
                    <input type="submit" name="kupitvip" id="submit" value="Kúpiť VIP" />
                     </dl>
                </fieldset>
				</div>
