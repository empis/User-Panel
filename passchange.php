...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a class="current">Nastavenia<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                        <li><a class="current" href="passchange.php" title="">Zmena hesla</a></li>
                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                        </ul>
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
...
$starepassword = $_POST["oldpass"];
$novepassword = $_POST["newpass"];
if($novepassword == "" || $starepassword == ""){
echo '
<center><img src="images/error.png"><font color="red">Nezadal si staré heslo alebo nové heslo.</font></center>
';
}else{
$spravnost = check_password_db($_SESSION["loginmeno"], $starepassword);
if($spravnost == false){
echo '
<center><img src="images/error.png"><font color="red">Zadal si nesprávne staré heslo.</font></center>
';
}else{
...
<div class="form">
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        <dt><label for="email">Staré heslo:</label></dt>
                        <dd><input type="text" name="oldpass" id="" size="54" /></dd>
                    </dl>
					<dl>
                        <dt><label for="email">Nové heslo:</label></dt>
                        <dd><input type="text" name="newpass" id="" size="54" /></dd>
                    </dl>
<dl class="submit">
                    <input type="submit" name="submitchange" id="submit" value="Submit" />
                     </dl>
                </fieldset>
				</form>
				</div>
